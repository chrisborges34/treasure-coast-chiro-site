...
import { HOURS_DISPLAY } from "@/lib/clinic-hours";
  ...
  head: () => ({
    meta: [
      { title: "Treasure Coast Spine & Disc Center — Chiropractor in West Palm Beach, FL" },
      {
        name: "description",
        content:
          "Non-surgical spinal decompression and chiropractic adjustments in West Palm Beach. Relief for herniated discs, sciatica, and chronic pain. Call (561) 684-1080.",
      },
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="sticky top-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-8 text-sm font-medium text-muted items-center">
            ...
            {user ? (
              ...
              >
                {role === "admin" ? "Admin" : "My Appointments"}
              </Link>
            ) : (
      ...
      <section id="location" className="py-24 bg-background border-t border-border">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20">
          <div className="animate-fade-up">
            ...
            <p className="text-3xl font-display font-extrabold tracking-tight mb-8">
              Hours of Operation
            </p>
      ...
      <footer className="bg-foreground text-background py-16">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-background/60 max-w-sm">
              Professional chiropractic care for the West Palm Beach community. Dedicated to
              restoring function and vitality through evidence-based practice.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-8">
            <div>
              ...
              <a
                href="tel:+15616841080"
                className="block text-sm mb-2 hover:text-primary transition-colors"
              >
                (561) 684-1080
              </a>
              <a
        ...
        <div className="max-w-7xl mx-auto px-6 pt-12 mt-12 border-t border-background/10">
          <p className="text-xs text-background/40">
            &copy; {new Date().getFullYear()} Treasure Coast Spine &amp; Disc Center. All rights
            reserved.
          </p>
        </div>
      </footer>
